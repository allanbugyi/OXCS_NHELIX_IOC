...
epicsShareExtern rset *pvar_rset_genSubRSET;
epicsShareExtern int (*pvar_func_genSubRecordSizeOffset)(dbRecordType *pdbRecordType);
...
static const recordTypeLocation rtl[35] = {
    ...
    {pvar_rset_genSubRSET, pvar_func_genSubRecordSizeOffset}
};
...
epicsShareExtern void (*pvar_func_register_func_alarmlookupProcess)(void);
...
int OXCS700_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    (*pvar_func_register_func_alarmlookupProcess)();
